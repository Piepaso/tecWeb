...
class DatabaseHelper{
    ...
    public function getPosts($n=-1) {
        $query = "SELECT idarticolo, titoloarticolo, imgarticolo, dataarticolo, nome, anteprimaarticolo FROM articolo, autore WHERE autore = idautore ORDER BY dataarticolo DESC";
